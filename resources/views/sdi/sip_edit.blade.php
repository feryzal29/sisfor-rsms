    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Update Data SIP</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if ($message = Session::get('success'))
                    ...
                    @endif
                <form action="{{ route('employee.sip.update', $sip->id) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <label>No. SIP</label>
                        <input type="text" name="no_sip" class="form-control" value="{{ $sip->no_sip }}">
                      </div>
                      <div class="form-group">
