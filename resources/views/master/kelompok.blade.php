    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Kelompok RS PKU Muhammadiyah Sekapuk</h3>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $item->index }}</td>
                    <td>
                      <a href="{{ route('kelompok.show', $item->id) }}" class="btn btn-success">Edit</a>
                      <a href="javascript:;" class="btn btn-danger btn-delete" data-action="{{ route('kelompok.destroy', $item->id) }}">Delete</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" name="kode_kelompok" class="form-control" placeholder="Kode Kelompok">
            </div>
            <div class="form-group">
              <label>Nama Kelompok</label>
              <input type="text" name="nama_kelompok" class="form-control" placeholder="Nama Kelompok">
            </div>
            <div class="form-group">
