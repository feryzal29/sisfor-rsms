    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Resiko Kerja RS PKU Muhammadiyah Sekapuk</h3>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $item->index }}</td>
                    <td>
                      <a href="{{ route('resikokerja.show', $item->id) }}" class="btn btn-success">Edit</a>
                      <a href="javascript:;" class="btn btn-danger btn-delete" data-action="{{ route('resikokerja.destroy', $item->id) }}">Delete</a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">TAMBAH DATA RESIKO KERJA</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="resikokerja" method="POST">
        @csrf
      <div class="modal-body">
            <div class="form-group">
              <label>Kode Resiko</label>
              <input type="text" name="kode_resiko" class="form-control" placeholder="Kode Resiko">
            </div>
            <div class="form-group">
              <label>Nama Resiko</label>
              <input type="text" name="nama_resiko" class="form-control" placeholder="Nama Resiko">
            </div>
            <div class="form-group">
