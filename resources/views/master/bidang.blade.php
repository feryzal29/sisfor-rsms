    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Bidang RS PKU Muhammadiyah Sekapuk</h3>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{ $item->nama }}</td>
                    <td>
                      <a href="{{ route('bidang.show', $item->id) }}" class="btn btn-success">Edit</a>
                      <a href="javascript:;" class="btn btn-danger btn-delete" data-action="{{ route('bidang.destroy', $item->id) }}">Delete</a>
