    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Jenjang Jabatan RS PKU Muhammadiyah Sekapuk</h3>
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{ $item->kode_jenjang }}</td>
                    <td>{{ $item->nama_jenjang }}</td>
                    <td>{{ $item->tunjangan }}</td>
                    <td>{{ $item->index }}</td>
                    <td>
                      <a href="{{ route('jenjang.show', $item->id) }}" class="btn btn-success">Edit</a>
                      <a href="javascript:;" class="btn btn-danger btn-delete" data-action="{{ route('jenjang.destroy', $item->id) }}">Delete</a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">TAMBAH DATA JENJANG JABATAN</h5>
      ...
      <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" name="kode_jenjang" class="form-control" placeholder="Kode Jenjang">
            </div>
            <div class="form-group">
